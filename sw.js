const CACHE = "learning-arcade-v17";
...
const ART = ["./assets/backgrounds/circuit-lab.jpg","./assets/backgrounds/metal-panel.jpg","./assets/backgrounds/mission-map.png","./assets/characters/circuit-sentinel-action.png","./assets/characters/circuit-sentinel-success.png","./assets/characters/circuit-sentinel-thinking.png","./assets/characters/professor-volt.png","./assets/ui/energy-orb.png"];
const SOUNDS = ["./audio/interface/game-select.mp3","./audio/interface/level-play.mp3","./audio/interface/round-finished.mp3","./audio/interface/answer-selected.wav","./audio/interface/professor-opening.mp3","./audio/interface/sentinel-start.mp3"];
